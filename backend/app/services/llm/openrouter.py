...
class OpenRouterProvider(BaseLLMProvider):
    def __init__(self, api_key: str):
        ...
        # We use a very lightweight, fast model for testing connection
        self.test_model = "openai/gpt-4o-mini"
    ...
    async def complete(
        ...
        async with httpx.AsyncClient() as client:
            headers = {
                ...
                "HTTP-Referer": "http://localhost:8000", # Need a referer for openrouter
            }
            payload = {
                "model": model,
                "messages": messages,
    ...
    async def test_connection(self, model: str | None = None) -> ProviderTestResult:
        ...
        try:
            ...
            await self.complete(messages=messages, model=test_model, max_tokens=10)
